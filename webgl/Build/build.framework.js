...
function _updateColorSensorData(R, G, B, Distance, Direction) {
 setColorSensorData(R, G, B, Distance, Direction);
}

function _updateDistanceSensorData(Distance) {
...
function _updateGripperEncoders(encoders) {
 setGripperEncoders(encoders);
}

function _updateIMUSensorData(x, y, z, angularX, angularY, angularZ, positionX, positionY, positionZ, orientationX, orientationY, orientationZ) {
 setIMUSensorData(x, y, z, angularX, angularY, angularZ, positionX, positionY, positionZ, orientationX, orientationY, orientationZ);
}

function _updateMotorEncoders(motorNum, encoders) {
 setMotorEncoders(motorNum, encoders);
}

function _updateSignalSensor(signalType) {
 setSignalSensor(signalType);
}

function _updateSlideEncoders(encoders) {
 setSliderEncoders(encoders);
}

function _updateTouchSensorData(Touch) {
...
var asmLibraryArg = {
 ...
 "invoke_v": invoke_v,
 "invoke_vffffffffffffi": invoke_vffffffffffffi,
 ...
 "strftime": _strftime,
 "time": _time,
 "updateBackLeftEncoders": _updateBackLeftEncoders,
 "updateBackRightEncoders": _updateBackRightEncoders,
 "updateColorSensorData": _updateColorSensorData,
 "updateDistanceSensorData": _updateDistanceSensorData,
 "updateFrontLeftEncoders": _updateFrontLeftEncoders,
 "updateFrontRightEncoders": _updateFrontRightEncoders,
 "updateGripperEncoders": _updateGripperEncoders,
 "updateIMUSensorData": _updateIMUSensorData,
 "updateMotorEncoders": _updateMotorEncoders,
 "updateSignalSensor": _updateSignalSensor,
 "updateSlideEncoders": _updateSlideEncoders,
 "updateTouchSensorData": _updateTouchSensorData,
 "utime": _utime
};
...
var dynCall_vffffffffffffi = Module["dynCall_vffffffffffffi"] = createExportWrapper("dynCall_vffffffffffffi");
...
var dynCall_iiffiiffi = Module["dynCall_iiffiiffi"] = createExportWrapper("dynCall_iiffiiffi");

var dynCall_viiiiffiiffi = Module["dynCall_viiiiffiiffi"] = createExportWrapper("dynCall_viiiiffiiffi");

var dynCall_viiiiiffiiffi = Module["dynCall_viiiiiffiiffi"] = createExportWrapper("dynCall_viiiiiffiiffi");
...
var dynCall_viiiiiffiiff = Module["dynCall_viiiiiffiiff"] = createExportWrapper("dynCall_viiiiiffiiff");
...
function invoke_vffffffffffffi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13) {
 var sp = stackSave();
 try {
  dynCall_vffffffffffffi(index, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13);
 } catch (e) {
  stackRestore(sp);
  if (e !== e + 0 && e !== "longjmp") throw e;
  _setThrew(1, 0);
